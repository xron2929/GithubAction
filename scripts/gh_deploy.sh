...
export DEPLOY_ERR_LOG_PATH="/home/ubuntu/$PROJECT_NAME/deploy_err.log"
export APPLICATION_LOG_PATH="/home/ubuntu/$PROJECT_NAME/application.log"
...
export DEPLOY_JAR=$DEPLOY_PATH$JAR_NAME
